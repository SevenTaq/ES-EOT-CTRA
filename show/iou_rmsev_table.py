...
scenario = 'turn_around'#'bus_change_lane'
...
paths = [
    ...
    os.path.join(root_path, 'ES-EOT-ES+/metrics_result'),
...
methods = [ 'ES-EOT (CV model)', 'ES-EOT (CV no ES)','ES-EOT (CTRV model)', 'ES-EOT (CTRV model+)','ES-EOT (CTRV no ES)', 'GPEOT', 'GPEOT-P', 'MEM-EKF*']
